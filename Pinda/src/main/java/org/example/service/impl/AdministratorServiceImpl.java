...
//    @Override
    ...
    @Override
    public void updateAdministratorById(Administrator administrator,String id){administratorMapper.updateAdministratorById(administrator);}

    @Override
    public List<Administrator> findAdministratorByNameAndPermissions(Administrator administrator){
        return administratorMapper.findAdministratorByNameAndPermissions(administrator);
    }
